        ...
        FastAutoGenerator.create("jdbc:mysql://localhost:3306/guli?serverTimezone=GMT%2B8", "root", "2550")
                .globalConfig(builder -> {
                    builder.author("znb") // 设置作者
                            ...
                            .outputDir("E:\\大三\\项目\\guli_test\\service\\service_ucenter\\src\\main\\java"); // 指定输出目录
                })
                .packageConfig(builder -> {
                    builder.parent("com.znb") // 设置父包名
                            ...
                            .service("service")
                            .mapper("mapper")
                            .pathInfo(Collections.singletonMap(OutputFile.mapperXml, "E:\\大三\\项目\\guli_test\\service\\service_ucenter\\src\\main\\resources"));// 设置mapperXml生成路径
                })
